            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="deals_you " id="panel2">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="service_btn">
                      <a id="pcs" class="btn btn-danger" href="{{route('UI_personal_concierge_service2')}}">personal concierge
                        service
                      </a>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="vid_img">
                      ...
                      <a data-fancybox="gallery" href="https://www.youtube.com/watch?v=-7aTH9G9ZaE" tabindex="0"><i
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
          <div class="eight">
            <video width="100%" preload="auto" loop="loop" muted="muted" id="videoBanner" class="videoBanner" autoplay>
